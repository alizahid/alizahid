...
const About: FunctionComponent = () => (
  <>
    ...
    <main className="flex flex-col justify-center">
      <section>
        <img
          className="h-64 w-64 rounded-full mx-auto shadow"
          src="/ali-zahid.jpg"
        />
        <h1 className="text-5xl font-semibold leading-tight mt-8">
      ...
      <footer className="flex flex-col lg:flex-row lg:items-center mt-8">
        ...
        <a
          ...
          <img alt="GitHub" className="h-8 w-8 mr-2" src="/social/github.svg" />
          GitHub
        </a>
        <a
          className="flex items-center text-black mt-4 lg:mt-0 lg:ml-4"
