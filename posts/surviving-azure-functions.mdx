...
I've taken a year's worth of learnings and put them into a package called <Link href="https://github.com/alizahid/tote">Tote</Link>.
...
Tote uses another package called <Link href="https://github.com/alizahid/tote-lib">`tote-lib`</Link> which has all the helpers in it.
