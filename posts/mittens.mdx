...
I started working on Mittens last year. I kept missing notifications from GitHub. Due to the volume of emails, I had filtered GitHub notifications out of my inbox. However, I was always late to the party. I was missing out on pull requests and issues unless someone also let me know on Slack.
...
<Image caption="Mittens architecture" image="/blog/mittens/architecture.png" />

The code, as usual, is publicly available on <Link href="https://github.com/mittens">GitHub</Link>.

Take it for a spin, and let me know what you think: <Link href="https://itunes.apple.com/us/app/mittens/id1453383568">Mittens on the App Store</Link>.
