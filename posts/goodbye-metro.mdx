...
<Image caption="Metro" image="/blog/goodbye-metro/metro.png" />
...
Last week, as part of my effort to update older apps, I started updating it. Better UX, newer maps, updated data using Firestore; the works. But then I came across this app: <Link external href="https://www.mapway.com/apps/dubai-metro">Dubai Metro Interactive Map</Link>.
